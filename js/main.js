    ...
    productsId.innerHTML += `
            <div class="col-lg-3 mb-3">
                <div class="product">
                    ...
                    <button class = "product__delete" data-id=${product.id} data-name=${product.name} data-price=${product.price}>Удалить из корзины<button>
                    </div
            </div>
`
})
...
const removeToBasketBtns = document.querySelectorAll(".product__delete");
...
removeToBasketBtns.forEach(removeToBasketBtn => {
    removeToBasketBtn.addEventListener('click', delBasket)
})
